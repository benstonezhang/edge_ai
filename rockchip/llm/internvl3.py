...
class InternVL3VisionForOnnx(torch.nn.Module):
...
class InternVL3MultiModalModel(MultiModalModel):
    @override
    @classmethod
    ...
    @override
    def get_vision(self):
        return InternVL3VisionForOnnx(self.model, self.batch_size, self.height, self.width)
